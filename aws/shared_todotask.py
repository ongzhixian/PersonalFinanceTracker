...
from azure.identity import AuthorizationCodeCredential, DeviceCodeCredential, AuthenticationRecord, TokenCachePersistenceOptions
from msgraph import GraphServiceClient
from kiota_abstractions.api_error import APIError

import pdb

class TodoTaskApi(object):
    ...
    def __init__(self):
        ...
        # Broker uri: ms-appx-web://Microsoft.AAD.BrokerPlugin/357dbf37-6fe6-46a2-a4d3-22afbb62c923
        # flow = app.initiate_device_flow(scopes=TodoTaskApi.SCOPES)
        # flow = app.initiate_auth_code_flow(scopes=TodoTaskApi.SCOPES, redirect_uri='urn:ietf:wg:oauth:2.0:oob')
        # flow = app.initiate_auth_code_flow(scopes=TodoTaskApi.SCOPES, redirect_uri='https://login.microsoftonline.com/common/oauth2/nativeclient')
