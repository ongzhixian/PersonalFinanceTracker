...
# Usage: .\deploy-sample.ps1 put_user_credential

########################################
# UTILITARIAN FUNCTIONS

Set-Variable package_name -Option Constant -Value 'sample'
...
# Usage: .\deploy-sample.ps1 dump_request
# Usage: .\deploy-sample.ps1 sample_write_google_sheet
...
$LambdaName = "sample_$FunctionName"
$moduleName = "sample_lambda"
